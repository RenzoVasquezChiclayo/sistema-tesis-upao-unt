...
function mostrarAlerta(mensaje, clase) {
    ...
    alertDiv.className = 'alert ' + clase;
...
function agregarRecurso() {
    ...
    if (tipo.selectedIndex == 0) {
        document.getElementById("span_recurso").innerHTML = "* Debe seleccionar el recurso";
    }else if(descripcion == "")
        document.getElementById("span_recurso").innerHTML = "* Debe agregar una descripcion";
    else{
        document.getElementById("span_recurso").innerHTML = "";
        ...
        var modal = document.getElementById('mRecurso');
...
function agregarObjetivo() {
    ...
    if (tipo.selectedIndex == 0) {
        document.getElementById("span_objetivo").innerHTML = "* Debe seleccionar el objetivo";
    }else if(descripcion == "")
        document.getElementById("span_objetivo").innerHTML = "* Debe agregar una descripcion";
    else{
        document.getElementById("span_objetivo").innerHTML = "";
        ...
        var modal = document.getElementById('mObjetivo');
        var bootstrapModal = bootstrap.Modal.getInstance(modal);
        bootstrapModal.hide();
    }
...
function validateDates(){
        const fecha_inicio = document.getElementById('txtfecha_inicio').value;
        const fecha_fin = document.getElementById('txtfecha_termino').value;
        const formatoFecha = /^\d{1,2}\/\d{1,2}\/\d{4}$/;
        if (fecha_inicio != "") {
            if (!formatoFecha.test(fecha_inicio)) {
                mostrarAlerta('El formato de fecha de inicio debe ser d/m/Y', 'alert-danger');
                return false;
            }

        }
        if (fecha_fin != "") {
            if (!formatoFecha.test(fecha_fin)) {
                mostrarAlerta('El formato de fecha debe de termino ser d/m/Y', 'alert-danger');
                return false;
            }
        }
        return true;
