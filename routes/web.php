...
Route::get('/configuraciones-iniciales',[AdminCursoController::class,'verConfiguracionesIniciales'])->name('admin.verConfiguraciones')->middleware('auth');
Route::post('/save-configuraciones-iniciales',[AdminCursoController::class,'saveConfiguracionesIniciales'])->name('admin.saveconfigurar')->middleware('auth');
