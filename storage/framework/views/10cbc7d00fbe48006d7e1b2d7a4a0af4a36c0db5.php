        ...
        <div class="row justify-content-around align-items-center">
            ...
            <div class="row">
                <div style="margin:5px;">
                    <a href="<?php echo e(route('director.verEditAsignacionJurados')); ?>" class="btn btn-modificaciones">Editar Asignacion</a>
                </div>
            </div>
            <form action="<?php echo e(route('director.saveAsignacionJurados')); ?>" method="post">
                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('plantilla.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Usuario\Desktop\UNT\Escuela_Contabilidad\ProyectoActualizado\sistema-tesis-upao-unt\resources\views/cursoTesis20221/director/evaluacion/asignacionDeJurados.blade.php ENDPATH**/ ?>