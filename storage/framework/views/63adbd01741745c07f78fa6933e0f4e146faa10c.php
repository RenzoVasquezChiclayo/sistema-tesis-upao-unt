...
<div class="card-body">
    <div class="row justify-content-around align-items-center">
        <div class="col-12">
                        ...
                        <div class="row">
                            <div class="input-group">
                                <input type="text" class="form-control" name="buscar_estudiante"
                                    placeholder="Codigo de matricula o Apellidos" value="<?php echo e($buscar_estudiante); ?>"
            ...
            <form action="<?php echo e(route('director.saveAsignarAsesorTesis')); ?>" method="post">
                <?php echo csrf_field(); ?>
                <div class="row mb-3" style="text-align:left; justify-content:flex-start">
                    <div class="flex-container my-2">
                        <a href="<?php echo e(route('director.editAsignacionAsesorTesis')); ?>" class="btn btn-modificaciones">Editar
                            Asignación</a>
                    </div>
                </div>
                    ...
                    <table id="table-proyecto" class="table table-striped table-responsive-md">
                        ...
                        <tbody>
                            ...
                            <?php $__currentLoopData = $estudiantes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $est): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td>
                                        <select name="cboAsesor_<?php echo e($cont); ?>" id="cboAsesor_<?php echo e($cont); ?>"
                                            ...
                                            <?php if($est->cod_asesor != null): ?> disabled <?php endif; ?>>
                                            ...
                                            <?php $__currentLoopData = $asesores; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ase): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($ase->cod_docente); ?>"
                                                    <?php if($est->cod_asesor == $ase->cod_docente): ?> selected <?php endif; ?>><?php echo e($ase->nombres." ".$ase->apellidos); ?>
                                    ...
                                    <td>
                                        <div class="row">
                                            <div class="col-12 col-lg-6 py-1 py-lg-0">
                                                <input class="btn btn-success w-100" id="btnAsesor_<?php echo e($cont); ?>"
                                                    type="button" value="+"
                                                    onclick="guardarAsesor(<?php echo e($cont); ?>);" hidden>
                                            </div>
                                            <div class="col-12 col-lg-6 py-1 py-lg-0">
                                ...
                                <input type="hidden" id="codEst_<?php echo e($cont); ?>" value="<?php echo e($est->cod_matricula); ?>">
...
<?php echo $__env->make('plantilla.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Usuario\Desktop\UNT\Escuela_Contabilidad\ProyectoActualizado\sistema-tesis-upao-unt\resources\views/cursoTesis20221/director/tesis/asignarAsesorTesis.blade.php ENDPATH**/ ?>