    ...
    <div class="col-12">
        <div class="row" style="display: flex; align-items:center;">
            <div class="col-12">
                ...
                <h1>EDITAR</h1>
                <form action="<?php echo e(route('director.saveEdicion')); ?>" method="post">
                    <?php echo csrf_field(); ?>
                                        ...
                                        >
                                            ...
                                            <?php $__currentLoopData = $asesores; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ase): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                ...
                                                <?php if($grupo[0]->cod_docente == $ase->cod_docente): ?>
                                                    selected
                                                <?php endif; ?>
                                                ><?php echo e($ase->cod_docente); ?>_<?php echo e($ase->nombres); ?></option>
                    ...
                    <a href="<?php echo e(route('director.asignarAsesorGrupos')); ?>" class="btn btn-danger">Volver</a>
                </form>
                <div>
...
<?php echo $__env->make('plantilla.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Usuario\Desktop\UNT\Escuela_Contabilidad\ProyectoActualizado\sistema-tesis-upao-unt\resources\views/cursoTesis20221/director/editarAsignacion.blade.php ENDPATH**/ ?>