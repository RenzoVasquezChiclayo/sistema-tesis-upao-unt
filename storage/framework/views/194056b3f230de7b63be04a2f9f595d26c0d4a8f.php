    ...
    <div class="container login-form box" style="margin-top:150px;">
        <div class="panel panel-default ">
            <div class="panel-body">
                <form action="<?php echo e(route('login.verificate')); ?>" method="post">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="login-userinput">
                        <input type="text" class="form-control" id="name" name="name" placeholder="Usuario" value="<?php echo e(old('name')); ?>" autofocus required>
                    </div>
                    <div style="">
    ...
    <div class="modal" id="mReset_Password">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <!-- Modal body -->
                <form action="<?php echo e(route('correo_reset')); ?>" method="post">
                    <?php echo csrf_field(); ?>
...
<script src="//cdn.jsdelivr.net/npm/sweetalert2@11"></script>
    ...
    <?php elseif(session('datos') == 'oknotregister'): ?>
        <script>
            Swal.fire({
                position: 'center',
                icon: 'error',
...
<?php /**PATH C:\Users\Usuario\Desktop\UNT\Escuela_Contabilidad\ProyectoActualizado\sistema-tesis-upao-unt\resources\views/login/login.blade.php ENDPATH**/ ?>