    ...
    <div class="card-body">
        ...
        <div class="row">
            <form id="formProyecto" name="formProyecto" action="" method="">
                <?php echo csrf_field(); ?>
                <input type="hidden" name="textcod" value="<?php echo e($Tesis[0]->cod_tesis); ?>">
                ...
                <div class="row" style="margin-bottom:20px; padding-right:12px;">
                    ...
                    <div class="row border-box card-box">
                        ...
                        <div class="item-card">
                            ...
                            <input class="form-control" name="txtDireccionAsesor" id="txtDireccionAsesor" type="text" value="<?php echo e($Tesis[0]->direccion); ?>" readonly>
                        </div>
                    </div>
                </div>
                <div class="row" style=" margin-bottom:20px">
                    ...
                    <div class="col-12">
                        <div class="row" style="text-align:left; ">
                            ...
                            <div class="col-3 col-md-3 my-2">
                                <a href="<?php echo e(route('asesor.estudiantes-tesis')); ?>" type="button" class="btn btn-outline-danger">Cancelar</a>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        function uploadProyecto(){
            ...
            if(!hayCorreccion){
                ...
                cancelButtonText: 'Cancelar',
                    ...
                    if (result.isConfirmed) {
                        document.formProyecto.action = "<?php echo e(route('asesor.guardar-observaciones')); ?>";
                        document.formProyecto.method = "POST";
                        document.formProyecto.submit();
                    }
                })
        ...
        function saveWithoutErrors(){
            ...
            if (validacionTesis == true){
                ...
                cancelButtonText: 'Cancelar',
                    ...
                    if (result.isConfirmed) {
                        document.formProyecto.action = "<?php echo e(route('asesor.guardar-sin-observaciones')); ?>";
                        document.formProyecto.method = "POST";
                        document.formProyecto.submit();
                    }
                })
...
<?php echo $__env->make('plantilla.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Usuario\Desktop\UNT\Escuela_Contabilidad\ProyectoActualizado\sistema-tesis-upao-unt\resources\views/cursoTesis20221/asesor/tesis/progreso-estudiante.blade.php ENDPATH**/ ?>