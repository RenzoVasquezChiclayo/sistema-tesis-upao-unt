...
<?php $__env->startSection('contenido'); ?>
    ...
    <div class="card-body">
        <?php
            $esEstadoValido = $cursoTesis[0]->estadoDesignacion <=1;
        ...
        <div class="row" style="text-align:start; justify-content:center;">
            <form id="formProyecto" name="formProyecto" action="" method="">
                <?php echo csrf_field(); ?>
                <input type="hidden" name="cod_proyectotesis" value="<?php echo e($cursoTesis[0]->cod_proyectotesis); ?>">
                ...
                <div class="row" style="margin-bottom:20px; padding-right:12px;">
                    ...
                    <div class="row border-box card-box" style="margin-bottom:8px">
                        ...
                        <div class="col-12 col-lg-6" <?php if($campos[0]->duracion_proyecto == 0): ?> hidden <?php endif; ?>>
                                        ...
                                        <table class="table" id="table-matriz" style="border: 5px;">
                                            ...
                                            <tbody>
                                                ...
                                                <tr id="table-matriz-tr">
                                                    <td>VI</td>
                                                    <td>
                                                        <textarea class="form-control" name="i_varI" rows="3" cols="8" readonly><?php if($matriz[0]->variable_I != null): ?><?php echo e($matriz[0]->variable_I); ?><?php endif; ?></textarea>
                                                    </td>
                                                    <td>
                                                        <textarea class="form-control" name="i_dc" rows="3" cols="8" readonly><?php if($matriz[0]->def_conceptual_I != null): ?><?php echo e($matriz[0]->def_conceptual_I); ?><?php endif; ?></textarea>
                                                    </td>
                                                    <td>
                                                        <textarea class="form-control" name="i_do" rows="3" cols="8" readonly><?php if($matriz[0]->def_operacional_I != null): ?><?php echo e($matriz[0]->def_operacional_I); ?><?php endif; ?></textarea>
                                                    </td>
                                                    <td>
                                                        <textarea class="form-control" name="i_dim" rows="3" cols="8" readonly><?php if($matriz[0]->dimensiones_I != null): ?><?php echo e($matriz[0]->dimensiones_I); ?><?php endif; ?></textarea>
                                                    </td>
                                                    <td>
                                                        <textarea class="form-control" name="i_ind" rows="3" cols="8" readonly><?php if($matriz[0]->indicadores_I != null): ?><?php echo e($matriz[0]->indicadores_I); ?><?php endif; ?></textarea>
                                                    </td>
                                                    <td>
                                                        <textarea class="form-control" name="i_esc" rows="3" cols="8" readonly><?php if($matriz[0]->escala_I != null): ?><?php echo e($matriz[0]->escala_I); ?><?php endif; ?></textarea>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>VD</td>
                                                    <td>
                                                        <textarea class="form-control" name="d_varD" rows="3" cols="8" readonly><?php if($matriz[0]->variable_D != null): ?><?php echo e($matriz[0]->variable_D); ?><?php endif; ?></textarea>
                                                    </td>
                                                    <td>
                                                        <textarea class="form-control" name="d_dc" rows="3" cols="8" readonly><?php if($matriz[0]->def_conceptual_D != null): ?><?php echo e($matriz[0]->def_conceptual_D); ?><?php endif; ?></textarea>
                                                    </td>
                                                    <td>
                                                        <textarea class="form-control" name="d_do" rows="3" cols="8" readonly><?php if($matriz[0]->def_operacional_D != null): ?><?php echo e($matriz[0]->def_operacional_D); ?><?php endif; ?></textarea>
                                                    </td>
                                                    <td>
                                                        <textarea class="form-control" name="d_dim" rows="3" cols="8" readonly><?php if($matriz[0]->dimensiones_D != null): ?><?php echo e($matriz[0]->dimensiones_D); ?><?php endif; ?></textarea>
                                                    </td>
                                                    <td>
                                                        <textarea class="form-control" name="d_ind" rows="3" cols="8" readonly><?php if($matriz[0]->indicadores_D != null): ?><?php echo e($matriz[0]->indicadores_D); ?><?php endif; ?></textarea>
                                                    </td>
                                                    <td>
                                                        <textarea class="form-control" name="d_esc" rows="3" cols="8" readonly><?php if($matriz[0]->escala_D != null): ?><?php echo e($matriz[0]->escala_D); ?><?php endif; ?></textarea>
                                                    </td>
                                                </tr>
                                                <?php else: ?>
                                                <tr>
                ...
                <div class="row" style="padding-top: 20px; padding-bottom:20px;">
                    <div class="d-grid gap-2 d-md-block">
                        <?php if($esEstadoValido && $esResultadoVacio && $sinObservaciones): ?>
                            <input class="btn btn-primary" type="button" id="btnConObservacion" value="Guardar observaciones" onclick="uploadProyecto();">
                        <?php endif; ?>
                        <a href="<?php echo e(route('jurado.listaProyectosAsignados')); ?>" type="button"
        ...
        function uploadProyecto() {
            ...
            if (!hayCorreccion) {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        document.formProyecto.action = "<?php echo e(route('jurado.guardarObservacionProyecto')); ?>";
                        document.formProyecto.method = "POST";
                        document.formProyecto.submit();
                    }
                })
...
<?php echo $__env->make('plantilla.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Usuario\Desktop\UNT\Escuela_Contabilidad\ProyectoActualizado\sistema-tesis-upao-unt\resources\views/cursoTesis20221/asesor/evaluacion/evaluarProyectoTesis.blade.php ENDPATH**/ ?>