                                    ...
                                    <?php endif; ?>>
                                        ...
                                        <td>
                                            ...
                                            <?php if($estu[0]->estado != 0): ?>
                                                <form id="form-revisaTema" action="<?php echo e(route('jurado.evaluarProyectoTesis')); ?>" method="POST">
                                                    <?php echo csrf_field(); ?>
                                                    <input type="hidden" name="id_grupo" value="<?php echo e($estu[0]->id_grupo); ?>">
                                                    <input type="hidden" name="cod_proyectotesis" value="<?php echo e($estu[0]->cod_proyectotesis); ?>">
                                        ...
                                        <td>
                                            <form id="formAprobarProyecto" name="formAprobarProyecto">
                                                ...
                                                <div class="form-check">
                                                    <input class="form-check-input" type="checkbox" value="" id="chkAprobado-<?php echo e($estu[0]->id_grupo); ?>" onclick="aprobarProyecto(this);" <?php if($estu[0]->estadoDesignacion > 1 || $estu[0]->numObs > 0 || ($estu[0]->estadoResultado != null && $estu[0]->estadoResultado ==1)): ?>disabled <?php endif; ?> <?php if($estu[0]->estadoResultado != null && $estu[0]->estadoResultado ==1): ?> checked <?php endif; ?>>
                                        ...
                                        <td><a href="<?php echo e(route('jurado.listaProyectosAsignados',['showObservacion'=>$estu[0]->cod_proyectotesis])); ?>">Ver detalle</a></td>
...
<?php $__env->startSection('js'); ?>
    ...
    <?php elseif(session('datos') == 'okAprobadoProyecto'): ?>
        <script>
            Swal.fire({
                position: 'center',
                icon: 'success',
    ...
    <?php elseif(session('datos') == 'oknotAprobadoProyecto'): ?>
        <script>
            Swal.fire({
                position: 'center',
                icon: 'error',
    ...
    <script type="text/javascript">
        function aprobarProyecto(chk){
            ...
            Swal.fire({
                ...
                chk.closest('#formAprobarProyecto').action = "<?php echo e(route('jurado.aprobarProyectoTesis')); ?>";
...
<?php echo $__env->make('plantilla.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Usuario\Desktop\UNT\Escuela_Contabilidad\ProyectoActualizado\sistema-tesis-upao-unt\resources\views/cursoTesis20221/asesor/evaluacion/listaProyectosAsignados.blade.php ENDPATH**/ ?>