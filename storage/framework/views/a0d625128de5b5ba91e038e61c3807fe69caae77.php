                            ...
                            <td style="text-align: center;">
                                <?php if($tesis->estado!=0): ?>
                                    <form id="tesis-download" action="<?php echo e(route('curso.descargar-tesis')); ?>" method="POST">
                                        ...
                                        <a href="#" onclick="this.closest('#tesis-download').submit()" <?php if($tesis->estado == 0): ?> hidden <?php endif; ?>><i class='bx bx-sm bx-download'></i></a>
                                    </form>
                                <?php endif; ?>
                            </td>
                        </tr>
...
<?php echo $__env->make('plantilla.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Usuario\Desktop\UNT\Escuela_Contabilidad\ProyectoActualizado\sistema-tesis-upao-unt\resources\views/cursoTesis20221/estudiante/evaluacion/estadoTesis.blade.php ENDPATH**/ ?>