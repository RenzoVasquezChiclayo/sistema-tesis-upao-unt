    ...
    <div class="row">
        <div class="col-12">
            <div class="row box-center">
                <div class="col-10">
                    <h4><b><?php echo e($estudiante[0]->nombres." ".$estudiante[0]->apellidos); ?></b></h4>
                            ...
                            <tbody>
                                ...
                                <?php $__currentLoopData = $observaciones; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $observacion): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td><?php echo e($observacion->fecha_create); ?></td>

                                        <td style="text-align: center;">
                                            <form id="observacion-download" action="<?php echo e(route('asesor.descarga-observacion')); ?>" method="POST">
                                                <?php echo csrf_field(); ?>
                                                <input type="hidden" name="cod_observaciones" value="<?php echo e($observacion->id_observacion); ?>">
                ...
                <div class="col-10">
                    ...
                    <a href="<?php echo e(route('user_information')); ?>" type="button" class="btn btn-danger" style="margin-left:20px;">Volver</a>
                </div>
            </div>
        </div>
    </div>
...
<?php echo $__env->make('plantilla.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Usuario\Desktop\UNT\Escuela_Contabilidad\ProyectoActualizado\sistema-tesis-upao-unt\resources\views/cursoTesis20221/asesor/tesis/lista-obs-estudiante.blade.php ENDPATH**/ ?>