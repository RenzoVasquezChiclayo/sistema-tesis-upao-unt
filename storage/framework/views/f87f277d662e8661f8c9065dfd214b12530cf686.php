                                ...
                                <div class="row">
                                    <table id="table-formato" class="table table-bordered table-responsive-md" style="table-border-color: red;">
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                            <tr>
                                                <td><?php echo e($proyecto->updated_at); ?></td>
                                                <td><?php echo e($proyecto->titulo); ?></td>
                                                <td><?php echo e($proyecto->nombre_asesor." ".$proyecto->apellidos_asesor); ?></td>
                                                ...
                                                <td style="text-align: center;">
                                                    <?php if($proyecto->estado!=0): ?>
                                                        <form id="proyecto-download" action="<?php echo e(route('curso.descargaTesis')); ?>" method="POST">
                                                            <?php echo csrf_field(); ?>
                                                            <input type="hidden" name="cod_cursoTesis" value="<?php echo e($proyecto->cod_proyectotesis); ?>">
                                                            <a href="#" onclick="this.closest('#proyecto-download').submit()" <?php if($proyecto->estado == 0): ?> hidden <?php endif; ?>><i class='bx bx-sm bx-download'></i></a>
                                                        </form>
                                                    <?php endif; ?>
                                                </td>
                                            </tr>
...
<?php echo $__env->make('plantilla.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Usuario\Desktop\UNT\Escuela_Contabilidad\ProyectoActualizado\sistema-tesis-upao-unt\resources\views/cursoTesis20221/estudiante/evaluacionProyecto/estadoProyecto.blade.php ENDPATH**/ ?>