    ...
    <div class="card-body">
        <div class="row" style="display: flex; align-items:center;">
            ...
            <div class="row border-box">
                ...
                <form action="<?php echo e(route('admin.guardarFacultad')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="col-12" style="margin-top: 10px;">
                        ...
                        <a href="<?php echo e(route('admin.verFacultad')); ?>" type="sub"
                                        ...
                                        <div class="row" style="display: flex;">
                                            <div class="col-auto">
                                                <a href="#" class="btn btn-warning"
                                                    onclick="editFacultad('<?php echo e($f->cod_facultad); ?>', '<?php echo e($f->nombre); ?>');">
...
<?php echo $__env->make('plantilla.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Usuario\Desktop\UNT\Escuela_Contabilidad\ProyectoActualizado\sistema-tesis-upao-unt\resources\views/cursoTesis20221/administrador/facultad/agregar_facultad.blade.php ENDPATH**/ ?>