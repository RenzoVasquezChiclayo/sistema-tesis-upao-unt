    ...
    <div class="card-body">
        <div class="row" style="display: flex; align-items:center;">
            ...
            <div class="row border-box">
                ...
                <form action="<?php echo e(route('admin.guardarPresupuesto')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="col-12" style="margin-top: 10px;">
                        ...
                        <a href="<?php echo e(route('admin.verPresupuesto')); ?>" type="sub"
                    ...
                    <div class="table-responsive">
                        <table id="table-proyecto" class="table table-striped table-responsive-md">
                            ...
                            <?php $__currentLoopData = $presupuesto; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    <td><?php echo e($p->codeUniversal); ?></td>
                                    <td><?php echo e($p->denominacion); ?></td>
                                    <td>
                                        <div class="row justify-content-center" style="display: flex;">
                                            <div class="col-auto">
                                                <a href="#" class="btn btn-warning"
                                                    onclick="editPresupuesto('<?php echo e($p->cod_presupuesto); ?>','<?php echo e($p->codeUniversal); ?>', '<?php echo e($p->denominacion); ?>');">
                                                    <i class='bx bx-sm bx-edit-alt'></i>
                                                </a>
                                            </div>
                                            <div class="col-auto">
                                                <form id="form-delete-presupuesto" method="post"
                                                    action="<?php echo e(route('admin.delete_presupuesto')); ?>">
                                                    <?php echo method_field('DELETE'); ?>
                                                    <?php echo csrf_field(); ?>
                                                    <input type="hidden" name="auxidpresupuesto"
                                                        value="<?php echo e($p->cod_presupuesto); ?>">
...
<?php echo $__env->make('plantilla.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Usuario\Desktop\UNT\Escuela_Contabilidad\ProyectoActualizado\sistema-tesis-upao-unt\resources\views/cursoTesis20221/administrador/presupuesto/agregar_presupuesto.blade.php ENDPATH**/ ?>