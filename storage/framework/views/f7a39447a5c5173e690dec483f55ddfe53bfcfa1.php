    ...
    <div class="card-body">
        <div class="row justify-content-around align-items-center">
            ...
            <div class="row border-box" style="margin-bottom: 30px;">
                <form action="<?php echo e(route('director.importarAlumnos')); ?>" method="post" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                        ...
                        <div class="col-2">
                            ...
                            <select class="form-select" onchange="select_semestre();" name="semestre_academico" id="semestre_academico" required>
                                <?php $__currentLoopData = $semestre_academico; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $s_a): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($s_a->cod_config_ini); ?>"><?php echo e($s_a->year); ?>_<?php echo e($s_a->curso); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                        </div>
                    </div>
            ...
            <div class="card text-center shadow bg-white rounded">
                <div class="card-body">
                    ...
                    <div class="row border-box">
                        <form action="<?php echo e(route('director.addEstudiante')); ?>" method="POST">
                            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('plantilla.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Usuario\Desktop\UNT\Escuela_Contabilidad\ProyectoActualizado\sistema-tesis-upao-unt\resources\views/cursoTesis20221/director/agregarAlumno.blade.php ENDPATH**/ ?>