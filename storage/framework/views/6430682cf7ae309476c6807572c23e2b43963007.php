...
<div class="card-header">
    Asignar asesor por grupos para proyecto de tesis
</div>
<div class="card-body">
    <div class="row" style="display:flex; align-items:center;">
        <div class="col-12">
            ...
            <form action="<?php echo e(route('director.saveAsesorAsignadoGrupos')); ?>" method="post">
                <?php echo csrf_field(); ?>
                <div class="row mb-3" style="text-align:left; justify-content:flex-start">
                    <div class="flex-container" style="display:flex;">
                        <div style="margin:5px;">
                            <a href="<?php echo e(route('director.veragregar')); ?>" class="btn btn-success"><i class='bx bx-sm bx-message-square-add'></i>Nuevo Alumno</a>
                        </div>
                        <div style="margin:5px;">
                            <a href="<?php echo e(route('director.editarAsignacion')); ?>" class="btn btn-modificaciones">Editar Asignacion</a>
                        </div>
                            ...
                            <?php $__currentLoopData = $studentforGroups; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $grupo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <?php if($grupo[0]->cod_docente != null): ?>
                                            disabled
                                        <?php endif; ?>
                                        >
                                            ...
                                            <?php $__currentLoopData = $asesores; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ase): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                ...
                                                <?php if($grupo[0]->cod_docente == $ase->cod_docente): ?>
                                                    selected
                                                <?php endif; ?>
...
<?php echo $__env->make('plantilla.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Usuario\Desktop\UNT\Escuela_Contabilidad\ProyectoActualizado\sistema-tesis-upao-unt\resources\views/cursoTesis20221/director/asignarAsesorGrupos.blade.php ENDPATH**/ ?>