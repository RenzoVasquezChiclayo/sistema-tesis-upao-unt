        ...
        <div class="row">
            <div class="col-12">
                <div class="row box-center">
                    <div class="col-10">
                        <h2><b>{{ $estudiante[0]->apellidos . ' ' . $estudiante[0]->nombres }}</b></h2>
                        <h5>{{ $estudiante[0]->cod_matricula }}</h5>
                    </div>
                                            ...
                                            <tr>
                                                ...
                                                <td style="text-align: center;">
                                                    <form id="observacion-download"
                                                        action="{{ route('asesor.descargaObservacion') }}" method="POST">
                                                        @csrf
                                                        <input type="hidden" name="cod_observaciones"
                                                            value="{{ $observacion->cod_observaciones }}">
                                                        <a href="#"
    ...
    @elseif (session('datos') == 'oknot')
        <script>
            Swal.fire({
                    icon: 'error',
                    title: 'Oops...',
                    text: 'Error al descargar el word, comuniquese con soporte.'
                })
        </script>
