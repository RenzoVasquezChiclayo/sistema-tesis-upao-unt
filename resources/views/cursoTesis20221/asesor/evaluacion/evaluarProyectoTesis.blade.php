    ...
    <div class="card-body">
        ...
        <div class="row" style="text-align:start; justify-content:center;">
            <form id="formProyecto" name="formProyecto" action="" method="">
                @csrf
                <input type="hidden" name="cod_proyectotesis" value="{{ $cursoTesis[0]->cod_proyectotesis }}">
                    ...
                    <div class="row" style=" margin-bottom:20px">
                        ...
                        <div class="col-12">
                            <div class="row" style="margin-bottom:8px">
                                ...
                                @if ($esEstadoValido && $esResultadoVacio && $sinObservaciones)
                ...
                <div class="row" style="margin-bottom:20px; padding-right:12px;">
                    ...
                    <div class="row border-box card-box" style="margin-bottom:8px">
                        ...
                        <div class="col-12 col-lg-6" @if ($campos[0]->duracion_proyecto == 0) hidden @endif>
                                        ...
                                        <table class="table" id="table-matriz" style="border: 5px;">
                                            ...
                                            <tbody>
                                                ...
                                                <tr id="table-matriz-tr">
                                                    <td>VI</td>
                                                    <td>
                                                        <textarea class="form-control" name="i_varI" rows="3" cols="8" readonly>@if ($matriz[0]->variable_I != null){{ $matriz[0]->variable_I }}@endif</textarea>
                                                    </td>
                                                    <td>
                                                        <textarea class="form-control" name="i_dc" rows="3" cols="8" readonly>@if ($matriz[0]->def_conceptual_I != null){{ $matriz[0]->def_conceptual_I }}@endif</textarea>
                                                    </td>
                                                    <td>
                                                        <textarea class="form-control" name="i_do" rows="3" cols="8" readonly>@if ($matriz[0]->def_operacional_I != null){{ $matriz[0]->def_operacional_I }}@endif</textarea>
                                                    </td>
                                                    <td>
                                                        <textarea class="form-control" name="i_dim" rows="3" cols="8" readonly>@if ($matriz[0]->dimensiones_I != null){{ $matriz[0]->dimensiones_I }}@endif</textarea>
                                                    </td>
                                                    <td>
                                                        <textarea class="form-control" name="i_ind" rows="3" cols="8" readonly>@if ($matriz[0]->indicadores_I != null){{ $matriz[0]->indicadores_I }}@endif</textarea>
                                                    </td>
                                                    <td>
                                                        <textarea class="form-control" name="i_esc" rows="3" cols="8" readonly>@if ($matriz[0]->escala_I != null){{ $matriz[0]->escala_I }}@endif</textarea>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>VD</td>
                                                    <td>
                                                        <textarea class="form-control" name="d_varD" rows="3" cols="8" readonly>@if ($matriz[0]->variable_D != null){{ $matriz[0]->variable_D }}@endif</textarea>
                                                    </td>
                                                    <td>
                                                        <textarea class="form-control" name="d_dc" rows="3" cols="8" readonly>@if ($matriz[0]->def_conceptual_D != null){{ $matriz[0]->def_conceptual_D }}@endif</textarea>
                                                    </td>
                                                    <td>
                                                        <textarea class="form-control" name="d_do" rows="3" cols="8" readonly>@if ($matriz[0]->def_operacional_D != null){{ $matriz[0]->def_operacional_D }}@endif</textarea>
                                                    </td>
                                                    <td>
                                                        <textarea class="form-control" name="d_dim" rows="3" cols="8" readonly>@if ($matriz[0]->dimensiones_D != null){{ $matriz[0]->dimensiones_D }}@endif</textarea>
                                                    </td>
                                                    <td>
                                                        <textarea class="form-control" name="d_ind" rows="3" cols="8" readonly>@if ($matriz[0]->indicadores_D != null){{ $matriz[0]->indicadores_D }}@endif</textarea>
                                                    </td>
                                                    <td>
                                                        <textarea class="form-control" name="d_esc" rows="3" cols="8" readonly>@if ($matriz[0]->escala_D != null){{ $matriz[0]->escala_D }}@endif</textarea>
                                                    </td>
                                                </tr>
                                                @else
                                                <tr>
        ...
        function uploadProyecto() {
            ...
            if (!hayCorreccion) {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        document.formProyecto.action = "{{ route('jurado.guardarObservacionProyecto') }}";
                        document.formProyecto.method = "POST";
                        document.formProyecto.submit();
                    }
                })
