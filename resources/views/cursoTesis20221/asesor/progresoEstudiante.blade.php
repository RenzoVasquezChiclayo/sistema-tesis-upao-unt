    ...
    <div class="" style="background-color:rgb(212, 212, 212)">
        ...
        <div class="row">
            <form id="formProyecto" name="formProyecto" action="" method="">
                        ...
                        <div class="col-12">
                            <div class="row" style="margin-bottom:8px">
                                <div class="col-9 col-md-8">
                                    <input class="form-control" name="txtTitulo" id="txtTitulo" type="text" value="{{$cursoTesis[0]->titulo}}" readonly>
                ...
                <div class="row" style=" margin-bottom:20px; padding-right:12px;">
                    ...
                    <div class="row" style="margin-bottom:8px;">
                        <div class="row">
                            <div class="col-5 col-md-3">
                                <input class="form-control" name="txtCodMatricula" id="txtCodMatricula" type="search" value="{{$cursoTesis[0]->cod_matricula}}" readonly>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row border-box card-box" >
                        <div class="item-card col">
                            ...
                            <input class="form-control" name="txtNombreAutor" id="txtNombreAutor" type="text" value="{{$cursoTesis[0]->nombresAutor}}" readonly>
                        </div>
                        <div class="item-card">
                            <label for="txtApellidoAutor" class="form-label">Apellidos</label>
                            <input class="form-control" name="txtApellidoAutor" id="txtApellidoAutor" type="text" value="{{$cursoTesis[0]->apellidosAutor}}" readonly>
                        </div>
                    </div>
                </div>
                <div class="row" style="margin-bottom:20px; padding-right:12px;">
                    ...
                    <div class="row border-box card-box">
                        <div class="item-card">
                            ...
                            <input class="form-control" name="txtNombreAsesor" id="txtNombreAsesor" type="text" value="{{$cursoTesis[0]->nombre_asesor}}" readonly>
                        </div>
                        <div class="item-card">
                ...
                <div class="row" style=" margin-bottom:20px; padding-right:12px;" @if($campos[0]->tipo_investigacion == 0) hidden @endif>
                    <div class="row">
                        <div class="col-3">
                            ...
                            @if ($cursoTesis[0]->estado==1)
                               <div class="col-4" align="center">
                                   <div class="row">
                                       <div class="col-12">
                                           <div class="form-check">
                                               <input class="form-check-input prueba" type="checkbox" id="chkCorregir23" onchange="chkCorregir(this);">
                                               <label class="form-check-label" for="flexCheckDefault">
                                                   Corregir
                                                </label>
                                            </div>
                    ...
                    <div class="row border-box card-box" style="margin-bottom:8px">
                        <div class="item-card col-4">
                            ...
                            <input class="form-control" type="text" name="cboTipoInvestigacion" id="cboTipoInvestigacion" value="@if($tipoinvestigacion->count()>0) {{$tipoinvestigacion[0]->descripcion}} @endif"readonly>
                        ...
                        <div class="item-card col-4">
                            ...
                            <input class="form-control" type="text" name="txtFinInvestigacion" id="txtFinInvestigacion" value="{{$cursoTesis[0]->ti_finpersigue}}" readonly>
                        </div>
                        <div class="item-card col-4">
                            <label for="cboDesignInvestigacion" class="form-label">De acuerdo al diseño de investigación</label>
                            <input class="form-control" type="text" name="txtDesignInvestigacion" id="txtDesignInvestigacion" value="{{$cursoTesis[0]->ti_disinvestigacion}}" readonly>
                        </div>
                        <div class="col-12">
                            <textarea class="form-control" name="tachkCorregir23" id="tachkCorregir23" cols="30" rows="4" hidden style="margin:10px 0px 10px;"></textarea>
                        </div>

                    </div>

                </div>
                <div class="row" style="margin-bottom:20px; padding-right:12px;" @if($campos[0]->localidad_institucion == 0) hidden @endif>
                        ...
                        <div class="row border-box" style="margin-left:0px;">
                            <div class="row">
                                ...
                                <div class="col-4" align="center">
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="form-check">
                                                <input class="form-check-input prueba" type="checkbox" id="chkCorregir2" onchange="chkCorregir(this);">
                                                <label class="form-check-label" for="flexCheckDefault">
                                                    Corregir
                                                </label>
                                            </div>
                            ...
                            <div class="row card-box" style="margin-bottom:8px">
                                <div class="item-card col-6">
                                    ...
                                    <input class="form-control" name="txtLocalidad" id="txtLocalidad" type="text" value="{{$cursoTesis[0]->localidad}}" readonly>
                                </div>

                                <div class="item-card col-6">
                                    <label for="txtInstitucion" class="form-label">Institucion</label>
                                    <input class="form-control" name="txtInstitucion" id="txtInstitucion" type="text" value="{{$cursoTesis[0]->institucion}}" readonly>
                                </div>
                        ...
                        <div class="row border-box">
                            ...
                            <div class="row" style="margin-bottom:8px">
                                <div class="col-10 col-lg-8">
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            <input class="form-control" name="txtMesesEjecucion" id="txtMesesEjecucion" type="text" value="{{$cursoTesis[0]->meses_ejecucion}}" readonly>
                                            <input type="hidden" id="valuesMesesPart" value="{{$cursoTesis[0]->t_ReparacionInstrum}},{{$cursoTesis[0]->t_RecoleccionDatos}},{{$cursoTesis[0]->t_AnalisisDatos}},{{$cursoTesis[0]->t_ElaboracionInfo}}">
                                        </div>
                                        <input type="text" name="datosCronograma" id=" " value="{{$cursoTesis[0]->t_ReparacionInstrum}}/{{$cursoTesis[0]->t_RecoleccionDatos}}/{{$cursoTesis[0]->t_AnalisisDatos}}/{{$cursoTesis[0]->t_ElaboracionInfo}}" hidden>
                                    </div>
                        ...
                        <table class="table">
                            ...
                            <tfoot>
                                <tr>
                                    ...
                                    <th>
                                        <p><strong>S/. @if($presupuesto->count()>0){{$presupuesto[0]->precio + $presupuesto[1]->precio + $presupuesto[2]->precio + $presupuesto[3]->precio + $presupuesto[4]->precio}}@endif</strong></p>
                                    </th>
                                </tr>
                            </tfoot>
                        </table>
                ...
                <div class="row" style="margin-bottom:20px" @if($campos[0]->financiamiento == 0) hidden @endif>
                    ...
                    <div class="row" style="margin-bottom:8px">
                        <div class="col-8 col-md-5">
                            <input class="form-control" type="text" name="txtFinanciamiento" id="txtFinanciamiento" value="{{$cursoTesis[0]->financiamiento}}" readonly>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row" style="margin-bottom:8px">
                        <div class="col-12 col-md-10">
                            <div class="form-floating">
                                <textarea class="form-control" name="taRProblematica" id="taRProblematica" style="height: 100px; resize:none" readonly>{{$cursoTesis[0]->real_problematica}}</textarea>
                            </div>
                        </div>
                        @if ($cursoTesis[0]->estado==1)
                ...
                <div class="row" style=" margin-bottom:20px" @if($campos[0]->rp_antecedente_justificacion == 0) hidden @endif>
                    ...
                    <div class="row" style="margin-bottom:8px">
                        <div class="col-12 col-md-10">
                            <div class="form-floating">
                                <textarea class="form-control" name="taAntecedentes" id="taAntecedentes" style="height: 100px; resize:none" readonly>{{$cursoTesis[0]->antecedentes}}</textarea>
                            </div>
                        </div>
                        @if ($cursoTesis[0]->estado==1)
                        <div class="col-2" align="center">
                ...
                <div class="row" style=" margin-bottom:20px" @if($campos[0]->rp_antecedente_justificacion == 0) hidden @endif>
                    ...
                    <div class="row" style="margin-bottom:8px">
                        <div class="col-12 col-md-10">
                            <div class="form-floating">
                                <textarea class="form-control" name="taJInvestigacion" id="taJInvestigacion" style="height: 100px; resize:none" readonly>{{$cursoTesis[0]->justificacion}}</textarea>
                            </div>
                        </div>
                        @if ($cursoTesis[0]->estado==1)
                        <div class="col-2" align="center">
                ...
                <div class="row" style=" margin-bottom:20px" @if($campos[0]->diseño_investigacion == 0) hidden @endif>
                    ...
                    <div class="row" style="margin-bottom:8px">
                        ...
                        <div class="col-12 col-md-10">
                            <div class="form-floating">
                                <textarea class="form-control" name="taRecoleccionDatos" id="taRecoleccionDatos" type="text" style="height: 100px; resize:none" readonly>{{$cursoTesis[0]->tecnicas_instrum}}</textarea>
                            </div>
                        </div>
                        @if ($cursoTesis[0]->estado==1)
                         <div class="col-2" align="center">
                    ...
                    <div class="row" style="margin-bottom:20px">
                        ...
                        <div class="col-12 col-md-10">
                            <div class="form-floating">
                                <textarea class="form-control" name="taFuentesDatos" id="taFuentesDatos" type="text" style="height: 100px; resize:none" readonly>{{$cursoTesis[0]->instrumentacion}}</textarea>
                            </div>
                        </div>
                        @if ($cursoTesis[0]->estado==1)
                            <div class="col-2" align="center">
                    ...
                    <div class="row" style="margin-bottom:20px">
                        ...
                        <div class="col-12 col-md-10">
                            <div class="form-floating">
                                <textarea class="form-control" name="taEstrategiasM" id="taEstrategiasM" style="height: 100px; resize:none" readonly>{{$cursoTesis[0]->estg_metodologicas}}</textarea>
                            </div>
                        </div>
                        @if ($cursoTesis[0]->estado==1)
                            <div class="col-2" align="center">
                ...
                <div class="row" style=" margin-bottom:20px; padding-right:12px;" @if($campos[0]->referencias_b == 0) hidden @endif>
                    <div class="col-12">
                        <hr style="border: 1px solid gray">
                    </div>
