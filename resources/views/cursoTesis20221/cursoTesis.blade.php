        ...
        <div class="col-12">
            ...
            <div class="row py-3" style="text-align: center;">
                <div class="col" style="align-items: center">
                    <h2 class="title-p"><strong>Registro de Proyectos</strong></h2>
                </div>
            </div>
            <div class="row">
                        ...
                        <div class="row border-box">
                            ...
                            <div class="col-12 col-sm-6 col-md-4 col-lg-3">
                                ...
                                <input class="form-control" name="txtGrAcademicoAsesor" id="txtGrAcademicoAsesor"
                                    type="text" value="{{ $asesor->grado_academico }}" placeholder="Grado academico"
                                    readonly>
                            </div>
                            <div class="col-12 col-sm-6 col-md-4 col-lg-3">
                                ...
                                <input class="form-control" name="txtTProfesional" id="txtTProfesional" type="text"
                                    value="{{ $asesor->titulo_profesional }}" placeholder="Titulo profesional" readonly>
                            </div>
                            <div class="col-12 col-sm-6 col-md-4 col-lg-3">
