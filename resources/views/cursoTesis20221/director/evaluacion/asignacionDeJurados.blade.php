                                            ...
                                            <td style="text-align: center;">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <select name="cbo2Jurado_{{ $cont }}"
                                                        ...
                                                        @foreach ($asesores as $ase)
                                                            @if($ase->cod_docente != $ta->cod_asesor)
                                                                <option value="{{ $ase->cod_docente }}" @if ($ta->cod_jurado2==$ase->cod_docente) selected @endif>{{ $ase->nombres . ' ' . $ase->apellidos }}</option>
                                                            @endif
                                                        @endforeach
                                                    </select>
                                                </div>
                                                <div class="row">
                                                    ...
                                                    <select name="cboVocal_{{ $cont }}"
                                                        ...
                                                        @foreach ($asesores as $ase)
                                                            @if($ase->cod_docente != $ta->cod_asesor)
                                                            <option value="{{ $ase->cod_docente }}"
                                                                @if ($ta->cod_vocal==$ase->cod_docente) selected @endif>
                                                                {{ $ase->nombres . ' ' . $ase->apellidos }}</option>
                                                            @endif
                                                        @endforeach
                                                    </select>
