    ...
    <div class="card-body">
        <div class="row" style="display:flex; align-items:center;">
            <div class="col-12">
                ...
                <form action="{{ route('director.saveAsesorAsignadoGrupos') }}" method="post">
                    @csrf
                            ...
                            <tbody>
                                ...
                                @foreach ($studentforGroups as $grupo)
                                    <tr>
                                        ...
                                        <td>
                                            <select name="cboAsesor_{{ $cont }}"
                                                id="cboAsesor_{{ $cont }}" class="form-control"
                                                onchange="validarSeleccion({{ $cont }});"
                                                @if ($grupo[0]->cod_docente != null) disabled @endif>
                                                <option value="0">-</option>
                                                @foreach ($asesores as $ase)
                                                    <option value="{{ $ase->cod_docente }}"
                                                        @if ($grupo[0]->cod_docente == $ase->cod_docente) selected @endif>
                                    ...
                                    <input type="hidden" id="codEst_{{ $cont }}_grupo"
